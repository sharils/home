...
alias mongo='docker run --interactive --rm --tty --volume $HOME/.mongorc.js:/home/mongodb/.mongorc.js --volume $HOME/.dbshell:/home/mongodb/.dbshell mongo mongo '
alias mongodump='docker run --interactive --rm --tty --volume $PWD:$PWD --workdir $PWD mongo mongodump'
alias mongojs='docker run --interactive --rm --tty mongo mongo --eval'
alias mongorestore='docker run --interactive --rm --tty --volume $PWD:$PWD --workdir $PWD mongo mongorestore'
