...
u() {
  ...
  e) $EDITOR "$HOME/Library/Preferences/qutebrowser/autoconfig.yml" "$HOME/.qutebrowser/bookmarks/urls" "$HOME/.qutebrowser/quickmarks" "$HOME/.qutebrowser/greasemonkey" "$HOME/.qutebrowser/config.py" ;;
