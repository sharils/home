...
x() {
  ...
  ai | ap | bc | cal | ct | data | editorconfig | erl | ex | focus | fx | getnf | gif | hbt | html | ico | jq | mh | paisa | pdf | png | py | rm | sh | smolsite | sn | sqlite | ssh-keygen | st | touch | tree | tz | venv | w8 | webp | whois | zip)
    cmd="$1" && shift
