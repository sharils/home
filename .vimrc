...
Plug 'shumphrey/fugitive-gitlab.vim' | Plug 'skywind3000/asyncrun.vim' | Plug 'tpope/vim-dispatch'| Plug 'tpope/vim-rhubarb' | Plug 'tpope/vim-fugitive' | Plug 'christoomey/vim-conflicted'
